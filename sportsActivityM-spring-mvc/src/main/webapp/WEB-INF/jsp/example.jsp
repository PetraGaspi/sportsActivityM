...
<jsp:attribute name="body">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            <th>r1</th>
            <td><c:out value="${r1}"/></td>
        </tr>
        <tr>
            <th>r2</th>
            <td><c:out value="${r2}"/></td>
        </tr>
        <tr>
            <th>b</th>
            <td><c:out value="${b}"/></td>
        ...
        <tr>
            <th>httpMethod</th>
            <td><c:out value="${httpMethod}"/></td>
        </tr>
        <tr>
            <th>userAgent</th>
            <td><c:out value="${userAgent}"/></td>
        </tr>
        <tr>
            <th>session_cookie</th>
            <td><c:if test="${not empty session_cookie}"> <c:out value="${session_cookie.name}"/>=<c:out
                    value="${session_cookie.value}"/></c:if></td>
        </tr>
        </tbody>
    </table>
